...
const LINE_ART: Record<string, string[]> = {
  ...
  // Filigree scrolls — ornate navy menus.
  ornate: [
    "M10 30c14 0 20-10 20-18 0 12 8 18 18 18-10 0-18 6-18 16 0-10-6-16-20-16Z",
    "M56 30h58M60 26c4 4 4 4 0 8m50-8c-4 4-4 4 0 8",
    "M122 30c14 0 20-10 20-18 0 12 8 18 18 18-10 0-18 6-18 16 0-10-6-16-20-16Z",
  ],
  // Cup, beans, croissant — vintage coffee house.
  coffee: [
    "M10 18h22v14a11 11 0 0 1-22 0Zm22 3h6a5 5 0 0 1 0 10h-6M6 44h30",
    "M54 30a8 8 0 1 0 16 0 8 8 0 1 0-16 0Zm8-8v16",
    "M82 32a9 9 0 1 0 18 0 9 9 0 1 0-18 0Zm9-9v18",
    "M116 38c4-12 16-18 28-15-2 11-13 18-28 15Zm7-4 7-5",
  ],
  // Fish, shell, anchor — nautical fine dining.
  seafood: [
    "M8 28c10-12 26-12 36 0-10 12-26 12-36 0Zm36 0 10-7v14ZM22 25h.01",
    "M70 40c-8 0-14-7-14-14h28c0 7-6 14-14 14Zm0 0V26m-7-2 4 14m10-14-4 14",
    "M112 12v28m-8-24h16m-16 20c0 6 4 10 8 10s8-4 8-10",
    "M138 40c8-10 8-20 0-28-8 8-8 18 0 28Z",
  ],
  shapes: [],
};

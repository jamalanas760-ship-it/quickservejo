...
export function TenantBrandShell({ children }: { children: ReactNode }) {
  ...
  const style: TenantStyle = {
    ...
    "--restaurant-dark-bg": "#11151b",
    "--restaurant-dark-topbar-bg": "#181d24",
    "--restaurant-dark-topbar-text": "#f6f8fb",
    "--restaurant-dark-sidebar-bg": "#181d24",
    "--restaurant-dark-sidebar-text": "#c7ced8",
    "--restaurant-dark-selected-nav": appearance.darkSelectedNavColor,
  };

  return (
    <>
      <style>{`.tenant-theme-scope{--background:var(--restaurant-light-bg)!important;--primary:var(--restaurant-light-primary)!important;--accent:var(--restaurant-light-accent)!important;--restaurant-topbar-bg:var(--restaurant-light-topbar-bg);--restaurant-topbar-text:var(--restaurant-light-topbar-text);--restaurant-sidebar-bg:var(--restaurant-light-sidebar-bg);--restaurant-sidebar-text:var(--restaurant-light-sidebar-text);--restaurant-selected-nav:var(--restaurant-light-selected-nav);background:var(--restaurant-light-bg);transition:background-color .18s ease}.dark .tenant-theme-scope{--background:var(--qs-canvas)!important;--primary:var(--restaurant-dark-primary)!important;--accent:var(--restaurant-dark-accent)!important;--restaurant-topbar-bg:var(--restaurant-dark-topbar-bg);--restaurant-topbar-text:var(--restaurant-dark-topbar-text);--restaurant-sidebar-bg:var(--restaurant-dark-sidebar-bg);--restaurant-sidebar-text:var(--restaurant-dark-sidebar-text);--restaurant-selected-nav:var(--restaurant-dark-selected-nav);background:var(--qs-canvas)!important}.tenant-theme-scope .bg-background{background-color:var(--background)!important}.tenant-theme-scope .qs-topbar{background:var(--restaurant-topbar-bg)!important;color:var(--restaurant-topbar-text)!important;border-color:var(--border)!important}.tenant-theme-scope .qs-topbar :is(a,button){color:inherit}.tenant-theme-scope .qs-sidebar-shell{background:var(--restaurant-sidebar-bg)!important;color:var(--restaurant-sidebar-text)!important;border-color:var(--border)!important}.tenant-theme-scope .qs-sidebar-shell .qs-sidebar-item{color:var(--restaurant-sidebar-text)!important}.dark .tenant-theme-scope :is([role=dialog],[role=menu],[role=listbox],[data-radix-popper-content-wrapper]>* ){background-color:var(--popover)!important;color:var(--popover-foreground)!important;border-color:var(--border)!important}.tenant-theme-scope .qs-sidebar-shell .qs-sidebar-item[data-active=true]{color:var(--restaurant-selected-nav)!important;background:color-mix(in oklab,var(--restaurant-selected-nav) 10%,transparent)!important}.tenant-theme-scope .qs-sidebar-shell .qs-sidebar-item[data-active=true]::before{background:var(--restaurant-selected-nav)!important}`}</style>

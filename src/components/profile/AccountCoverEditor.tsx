  ...
  return <section className="qs-card overflow-hidden">
    ...
    <div className="p-4 sm:p-6">
      <div ref={frameRef} onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={onPointerUp} onPointerCancel={() => { dragRef.current = null; }} className={cn("relative h-52 touch-none overflow-hidden rounded-[24px] border border-border bg-[radial-gradient(circle_at_20%_0%,rgba(232,93,42,.16),transparent_58%)] sm:h-64", state.url && "cursor-grab active:cursor-grabbing")}>
        ...
        {busy ? <div className="pointer-events-none absolute inset-0 grid place-items-center bg-background/25 backdrop-blur-[1px]"><span className="grid size-10 place-items-center rounded-full bg-background shadow"><Loader2 className="size-5 animate-spin text-[#e85d2a]" /></span></div> : null}
      </div>

...
function RuleCard({rule,restaurantId,ar,lang,onOpen}:{rule:OperationalRule;restaurantId:string;ar:boolean;lang:"en"|"ar";onOpen:()=>void}) {
  ...
  return <article role="button" tabIndex={0} onClick={onOpen} onKeyDown={(e)=>{if(e.key==="Enter"||e.key===" "){e.preventDefault();onOpen()}}} className="cursor-pointer p-4 outline-none transition hover:bg-muted/20 focus-visible:ring-2 focus-visible:ring-[#e85d2a] sm:p-5">

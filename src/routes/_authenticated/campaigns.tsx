    ...
    <main className="qs-page space-y-5">
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,.9fr)_minmax(0,1.1fr)]">
        ...
        <article className="qs-card overflow-hidden">
          <div className="border-b border-border p-5"><h2 className="font-display text-xl font-bold">{ar?"سجل الحملات":"Campaign history"}</h2><p className="mt-1 text-xs text-muted-foreground">{ar?"الحالة والأرقام من طابور التسليم الحقيقي.":"Statuses and counts come from the real delivery queue."}</p></div>

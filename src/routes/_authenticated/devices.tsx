    ...
    <main className="qs-page qs-compact-page qs-viewport-page">
      ...
      <section className="qs-viewport-fill grid min-h-0 gap-2 overflow-hidden xl:grid-cols-[250px_minmax(0,1fr)_300px]">
        <article className="qs-card qs-scroll-region min-h-0 p-3">
          <div className="flex items-start gap-2"><span className="grid size-8 place-items-center rounded-[9px] bg-orange-500/10 text-[#e85d2a]"><TabletSmartphone className="size-3.5"/></span><div><h2 className="text-sm font-bold">{ar?"تسجيل هذا الجهاز":"Register this device"}</h2><p className="mt-0.5 text-[10px] leading-4 text-muted-foreground">{ar?"سجل هذا المتصفح كجهاز QuickServe وراقب توفره.":"Register this browser as a QuickServe device and monitor its availability."}</p></div></div>
        ...
        <article className="qs-card flex min-h-0 flex-col overflow-hidden">
          <div className="border-b border-border p-3"><div className="flex items-center gap-2"><Printer className="size-4 text-[#e85d2a]"/><h2 className="qs-section-title">{ar?"طابعات المطبخ":"Kitchen printers"}</h2></div><p className="mt-0.5 text-[10px] text-muted-foreground">{ar?"تعريفات الطباعة المرتبطة بمحطات KDS.":"Printer definitions and KDS station mappings."}</p></div>

...
function PdfOrderPage() {
  ...
  return <div className="min-h-screen bg-background pb-24">
    ...
    <main className="pt-2"><PdfMenuViewer url={pdfMenu.url} pageCount={pdfMenu.pageCount} links={pdfMenu.links} items={menu.data.items} onSelect={(item) => canOrder && setDetail(item)} cartCount={cartCount} onCart={() => setCartOpen(true)} showCart={canOrder}/></main>

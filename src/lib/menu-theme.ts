...
> = {
  ...
  // Bold black-and-white bill of fare: crest medallion, FOOD / DRINK split,
  // dotted leaders and a photo strip at the foot.
  duotone: {
    label: { en: "Duotone bill of fare", ar: "قائمة أبيض وأسود" },
    theme: {
      template: "duotone",
      bg: "#f7f7f5",
      surface: "#ffffff",
  ...
  // Warm cream gastronomy broadsheet: three editorial columns around a
  // centred plated hero, pill section tabs, filigree crest.
  gastro: {
    label: { en: "Gastronomy broadsheet", ar: "صحيفة الأطباق" },
    theme: {
      template: "gastro",
      bg: "#f3ece1",
      surface: "#fbf7f0",
  ...
  // Sand + burnt-orange spine with an oversized vertical MENU wordmark.
  terracotta: {
    label: { en: "Terracotta spine", ar: "عمود تراكوتا" },
    theme: {
      template: "terracotta",
      bg: "#e8dbc8",
      surface: "#f2e7d7",
      ...
      upperTitles: true,
      scriptAccent: false,
      tagline: "Fresh kitchen",
    },
  },
  // Deep maroon information sidebar with serif print columns and hours block.
  maroon: {
    label: { en: "Maroon print sidebar", ar: "شريط عنابي مطبوع" },
    theme: {
      template: "maroon",
      bg: "#faf8f5",
      surface: "#ffffff",
  ...
  // Cocoa poster: huge FOOD MENU banner, thin rules, wine-red feature panel.
  cocoa: {
    label: { en: "Cocoa poster menu", ar: "ملصق كاكاو" },
    theme: {
      template: "cocoa",
      bg: "#4a2f2c",
      surface: "#5d3a35",
  ...
  // Playful ink-blob layout with amber pills and circular food crops.
  playful: {
    label: { en: "Ink blob playful", ar: "كتل حبرية مرحة" },
    theme: {
      template: "playful",
      bg: "#f3efe6",
      surface: "#ffffff",
